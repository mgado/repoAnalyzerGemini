...
import pytest
from repo_analyzer_agent.gemini_analyzer_with_url_context import analyze_repo_with_llm


# --- Tests (for local execution with a real GEMINI API key). Make optional for CI/CD---
...
class TestGeminiRealAPI:
    ...
    def test_analyze_repo_with_llm_invalid_model(self):
        """
